# beginners/source — інструкції для Codex

Чинні правила проєкту — в корені: `/AGENTS.md` (робочий процес, внесок у
дизайн-систему, правило «залишаємо») і `/CLAUDE.md` (бриф, дизайн-контракт).
Цей каталог поза `prototype/` — архівний знімок ранніх уроків, див.
`CLAUDE.md` поруч; його ранній бриф і `PRODUCT.md` не є чинними. Живий шар —
тільки `prototype/` (`/lesson-6/`), правила — `prototype/_rules.md`.

Нижче — правила лише для перенесення макетів у Figma через Figmosha
(застосовуються тоді, коли така робота замовлена).
