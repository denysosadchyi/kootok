...
>
> **Персони.** Flow 1, 2 і 4 — з боку Марічки (primary), Flow 3 — Олега (secondary).
> Настя (secondary, тікає від рієлторів) проходить той самий Flow 1 з
> фільтром «Оренда з нуля, власник напряму» (Related 4, контентна політика
> «лише приватні оголошення»); окремий флоу для неї — backlog.
...
- *Додати соцлінк (II.2)?* — опційний крок після профілю (пунктир): Instagram/LinkedIn дає доказ «соцмережу привʼязано» на картках; без нього флоу йде далі, лише з базовим рівнем довіри (телефон).
